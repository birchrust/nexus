//! Cycle-accurate random access latency comparison using rdtscp.
//!
...
//!
//! Run with:
//!   cargo build --release --example perf_indexing_cycles
...
fn main() {
    ...
    println!(
        "INDEXING latency comparison ({} random gets, seed={})",
        OPS, SEED
    );
    println!("========================================");
    println!();
