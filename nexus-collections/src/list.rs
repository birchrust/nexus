...
impl<T, K: Key, S> Iterator for Keys<'_, T, K, S>
where
    S: Storage<ListNode<T, K>, Key = K>,
{
    type Item = K;
...
impl<T, K: Key, S> DoubleEndedIterator for Keys<'_, T, K, S>
where
    S: Storage<ListNode<T, K>, Key = K>,
{
    #[inline]
...
impl<T, S, K: Key> Iterator for Drain<'_, T, S, K>
where
    S: Storage<ListNode<T, K>, Key = K>,
{
    type Item = T;
