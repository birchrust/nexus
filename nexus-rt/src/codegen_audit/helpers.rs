...
pub fn add_three(x: u64) -> u64 {
    x.wrapping_add(3)
}
pub fn square(x: u64) -> u64 {
    x.wrapping_mul(x)
}
pub fn sub_ten(x: u64) -> u64 {
    x.wrapping_sub(10)
}
pub fn shr_one(x: u64) -> u64 {
    x >> 1
}
pub fn xor_mask(x: u64) -> u64 {
    x ^ 0xDEAD_BEEF
}
pub fn add_seven(x: u64) -> u64 {
    x.wrapping_add(7)
}
pub fn triple(x: u64) -> u64 {
    x.wrapping_mul(3)
}
pub fn add_forty_two(x: u64) -> u64 {
    x.wrapping_add(42)
}

// -- Arity 1 — one Res/ResMut ------------------------------------

pub fn add_res_a(a: Res<ResA>, x: u64) -> u64 {
    x.wrapping_add(a.0)
}
pub fn mul_res_b(b: Res<ResB>, x: u64) -> u64 {
    x.wrapping_mul(b.0 as u64)
}
...
pub fn four_params(a: Res<ResA>, b: Res<ResB>, c: Res<ResC>, d: Res<ResD>, x: u64) -> u64 {
    x.wrapping_add(a.0)
        .wrapping_add(b.0 as u64)
        .wrapping_add(c.0 as u64)
...
pub fn checked_double(x: u64) -> Option<u64> {
    x.checked_mul(2)
}
...
pub fn consume_val(mut a: ResMut<ResA>, x: u64) {
    a.0 = a.0.wrapping_add(x);
}
...
pub fn ref_add_one(x: &u64) -> u64 {
    x.wrapping_add(1)
}
pub fn ref_double(x: &u64) -> u64 {
    x.wrapping_mul(2)
}
pub fn ref_add_three(x: &u64) -> u64 {
    x.wrapping_add(3)
}
pub fn ref_square(x: &u64) -> u64 {
    x.wrapping_mul(*x)
}
pub fn ref_sub_ten(x: &u64) -> u64 {
    x.wrapping_sub(10)
}
pub fn ref_shr_one(x: &u64) -> u64 {
    x >> 1
}
pub fn ref_xor_mask(x: &u64) -> u64 {
    x ^ 0xDEAD_BEEF
}
pub fn ref_add_seven(x: &u64) -> u64 {
    x.wrapping_add(7)
}
pub fn ref_triple(x: &u64) -> u64 {
    x.wrapping_mul(3)
}
pub fn ref_add_forty_two(x: &u64) -> u64 {
    x.wrapping_add(42)
}

pub fn ref_add_res_a(a: Res<ResA>, x: &u64) -> u64 {
    x.wrapping_add(a.0)
}
pub fn ref_mul_res_b(b: Res<ResB>, x: &u64) -> u64 {
    x.wrapping_mul(b.0 as u64)
}
...
pub fn ref_consume(mut a: ResMut<ResA>, x: &u64) {
    a.0 = a.0.wrapping_add(*x);
}
...
pub fn merge_add(a: &u64, b: &u64) -> u64 {
    a.wrapping_add(*b)
}
pub fn merge_mul(a: &u64, b: &u64) -> u64 {
    a.wrapping_mul(*b)
}
...
pub fn splat_add(a: u32, b: u32) -> u64 {
    a as u64 + b as u64
}
...
pub fn ref_splat_add(a: &u32, b: &u32) -> u64 {
    *a as u64 + *b as u64
}
