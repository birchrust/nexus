...
/// cast, for passing to adaptive filters (`LmsFilterF64`, `RlsFilterF64`),
/// classifiers (`LogisticRegressionF64`, `OnlineKMeansF64`),
/// and optimizers (`AdamF64`, `AdaGradF64`) from the `nexus-stats-regression` crate.
///
